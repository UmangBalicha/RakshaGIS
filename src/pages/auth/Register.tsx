    ...
    <div className="mx-auto max-w-md">
      <Card>
        <CardHeader>
          ...
          <p className="mt-1 text-sm text-slate-500">Report incidents faster and track their status.</p>
        </CardHeader>
        <CardContent>
          <form onSubmit={(e) => void handleSubmit(onSubmit)(e)} className="space-y-4" noValidate>
            <div>
              <Label htmlFor="full_name" required>Full name</Label>
              <Input id="full_name" autoComplete="name" placeholder="e.g. Ananya Gupta" {...register('full_name')} />
            ...
            <div>
              ...
              <Input id="phone" type="tel" autoComplete="tel" placeholder="+91 98XXX XXXXX" {...register('phone')} />
