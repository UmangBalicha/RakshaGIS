...
export default function TrackReport() {
    ...
    const handleLookup = async () => {
        ...
        try {
            ...
            if (!r)
                toast.error('No report found with that ID.');
            setLookupResult(r);
        }
        catch {
